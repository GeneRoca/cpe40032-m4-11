...
function Board:calculateMatches()
    ...
    for y = 1, 8 do
        ...
        -- CRUSH 3 UPDATE: IF TILE IN MATCH IS SHINY
        ...
        for x = 2, 8 do
            ...
            if self.tiles[y][x].color == colorToMatch then
                ...
                if matchNum >= 3 then
                    ...
                    -- CRUSH 3 UPDATE: IF TILE IN MATCH IS SHINY THEN ADD ALL TILES IN THE ROW TO MATCH
                    if shinyMatch then
                        for rowX = 1, 8 do
...
--CRUSH 3 UPDATE: TO REVERT BACK A TILE IF NO POSSIBLE MATCH
