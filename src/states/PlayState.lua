...
function PlayState:calculateMatches()
    ...
    if matches then
        ...
        for k, match in pairs(matches) do
            ...
            -- CRUSH 3 UPDATE: SCORE DEPENDS ON THE TILE VARIETY
            ...
            -- CRUSH 3 UPDATE: ADD SECONDS TO TIME EQUAL TO NUMBER OF TILES MATCHED
        ...
        return true
    -- CRUSH 3 UPDATE: IF NO MATCH THEN RESET TILES MESSAGE WILL APPEAR AND WILL INITIALIZE NEW TILES
